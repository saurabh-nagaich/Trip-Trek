      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " update successfully!")); // location.reload(true)
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2F1cmFiaG5hZ2FpY2giLCJhIjoiY2tzdm9xNmxqMGUzdTMxcHQ4aHg5MXQ4MCJ9.LfhI-l0W6l0oiCi_XtkJPA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/saurabhnagaich/cksvp9aju1caf17qn8mu072x8',
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    (0, _stripe.bookTour)(tourId); // e.target.textContent = 'Processing'
  });
}
